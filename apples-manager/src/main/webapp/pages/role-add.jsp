...
<div class="x-body">
    ...
    <form action="addRole" method="post" class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="name" name="rname" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" disabled="disabled" value="${ros.rname}">
            </div>
        </div>
                    ...
                    <div class="layui-input-block">
                        <td>
                            <c:forEach items="${auths}" var="auth">
                                <input name="auids" value="${auth.auid}" lay-skin="primary" type="checkbox" title="${auth.auname}">
                            </c:forEach>
                        </td>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="desc" name="rdesc" class="layui-textarea">${ros.rdesc}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    $(function () {
        $.each(${authides},function(i,auid){
            $("input[name='auids'][value="+auid+"]").attr("checked",true);
        });
    });
